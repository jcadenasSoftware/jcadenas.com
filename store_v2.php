    ...
    <div class="row align-items-start g-4">
      ...
      <div class="col-md-6">
        ...
        <?php else: ?>
          ...
          <div class="d-grid gap-2 mt-3">
            <a href="#payment-methods" class="btn btn-success btn-lg smooth-link">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane fade show active" id="colombia-pay" role="tabpanel">
        ...
        <div class="payment-logos mb-4">
          <?php
          $paymentLogos = [
            ['name' => 'Nequi', 'file' => 'nequi.svg'],
            ['name' => 'Daviplata', 'file' => 'daviplata.svg'],
            ['name' => 'Bancolombia', 'file' => 'bancolombia.svg'],
            ['name' => 'Movii', 'file' => 'movii.svg'],
            ['name' => 'Ualá', 'file' => 'uala.svg'],
          ];
          foreach($paymentLogos as $logo):
            $logoPath = __DIR__ . '/assets/img/payments/' . $logo['file'];
            if(file_exists($logoPath)):
          ?>
            <img src="<?= $base ?>/assets/img/payments/<?= htmlspecialchars($logo['file']) ?>" 
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body p-4">
            <h5 class="mb-3">
              <i class="bi bi-file-earmark-check text-primary me-2"></i>¿Ya realizaste el pago?
            </h5>
            <p class="text-muted mb-4">Envía tu comprobante para recibir el enlace de descarga.</p>
            
            <form action="<?= $base ?>/purchase_create.php" method="post" enctype="multipart/form-data">
